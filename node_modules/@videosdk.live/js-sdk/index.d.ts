...
export namespace VideoSDK {
   ...
   * ---
   * @param metaData - You can include extra details about a meeting participant, like their profile image, by passing that information through this parameter.
   * ---
   * @param mode -
   *
   ...
   * ---
   * @param debugMode - Enables users to view detailed error logs generated by our SDK directly on the VideoSDK's dashboard.
   * ---
   *
   */
   ...
   * ---
   * @param multiStream - It will specifiy if the stream should send multiple resolution layers or single resolution layer. Please refere thi link for more understanding
   * [What is multiStream ?](https://docs.videosdk.live/javascript/guide/video-and-audio-calling-api-sdk/render-media/optimize-video-track#what-is-multistream)
   *
   * **Code Example**
   * ```js
   * import VideoSDK from "@videosdk.live/js-sdk";
   ...
   */
  function getCameras(): Promise<Array<CameraDeviceInfo>>;
  /**
   *
   * @returns {Promise<Array<MicrophoneDeviceInfo>>}
   */
  function getMicrophones(): Promise<Array<MicrophoneDeviceInfo>>;
  /**
   *
  ...
  function getPlaybackDevices(): Promise<Array<PlaybackDeviceInfo>>;
  /**
   *
   * @returns {Promise<Array<DeviceInfo>>}
   */
  function getDevices(): Promise<Array<DeviceInfo>>;
  /**
   * Add event listener
   * @param { "device-changed" } eventType
   * @param {Function} listener Callback function
   */
  function on(eventType: "device-changed", listener: Function): void;
  /**
   * Remove event listener
   * @param { "device-changed" } eventType
   * @param {Function} listener Callback function
   */
  function off(eventType: "device-changed", listener: Function): void;
  /**
   *
   * @param {string} permissions
   * @returns {Promise<Map<string, boolean>>}
   */
  function checkPermissions(permissions: string): Promise<Map<string, boolean>>;
  /**
   *
   * @param {string} permissions
   * @returns {Promise<Map<string, boolean>>}
...
import { CharacterMode, CharacterState } from "./character";
import {
  CameraDeviceInfo,
  DeviceInfo,
